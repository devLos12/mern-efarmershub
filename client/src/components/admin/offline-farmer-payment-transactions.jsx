...
const OfflineFarmerPaymentTransactions = () => {
    ...
    const handleDownloadPDF = () => {
        ...
        html2pdf().set({
            margin: 10,
            filename: `transactions_${payoutDate}_${new Date().getTime()}.pdf`,
    ...
    return (
        <div className="p-2 mb-5">
            ...
            {/* ── Bottom Nav (PDF + Print + Pagination) — same as Transactions.jsx ── */}
            {filteredTransactions.length > 0 && (
...
export default OfflineFarmerPaymentTransactions;