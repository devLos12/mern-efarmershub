    ...
    return (
        <>
            {filteredProduct.length > 0 ? (
                <>
                    ...
                    {filteredProduct.length > 0 ? (
                        <div className="row g-0">
                            ...
                            <div className="col-12 d-flex justify-content-end " style={{ cursor: "pointer" }}>
                                <div
                                    className="me-3 btn btn-sm border-0 btn-outline-dark mt-4  d-flex align-items-center gap-2 justify-content-center"
                                    onClick={() => {
                ...
                <div className="row g-0 d-flex align-items-center justify-content-center" style={{ height: "420px" }}>
                    <div className="col-12 text-center ">
                        <i className="fa-solid fa-fire fs-3 text-muted"></i>
                        <p className="text-muted mb-3">No product found.</p>
                    </div>
                </div>
            )}
        </>
