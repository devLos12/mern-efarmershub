...
import { getNotification, readNotification, sellerGetNotification, deleteNotification } from "../controllers/notification.js";
...
sellerRouter.patch("/sellerDeleteNotif/:id", authMiddleware, deleteNotification);
