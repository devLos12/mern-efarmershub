...
import { getNotification, readNotification, userGetNotification, deleteNotification } from "../controllers/notification.js";
...
userRouter.patch('/userDeleteNotif/:id', authMiddleware, deleteNotification);
